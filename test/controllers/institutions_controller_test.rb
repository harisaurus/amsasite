...
class InstitutionsControllerTest < ActionController::TestCase
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post :create, institution: { description: @institution.description, location: @institution.location, members: @institution.members, name: @institution.name }
    end
  ...
  test "should update institution" do
    patch :update, id: @institution, institution: { description: @institution.description, location: @institution.location, members: @institution.members, name: @institution.name }
    assert_redirected_to institution_path(assigns(:institution))
  end
